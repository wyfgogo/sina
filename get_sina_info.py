...
# keywords = {
    ...
    # "17816874847":["纸巾"] #凌峰
# }
keywords = read_json("keywords.json")
#["瑞幸"] 关键字
header = {
            ...
            for item in data_list:
                ...
                if  item["id"] > id_json[uid]:
                    ...
                    if item["pic_num"] == 1:
                        ...
                        message = parse_message(item.get("user").get("screen_name")+'\\\n'+'\\\n'+item.get("text")+'\\\n'+"![]"+"("+pic+")")
                    if item.get("user").get("screen_name") == "薅羊毛的大队长":
                        phone_list = []
                        phone_list.append("19157707002")
                        message = message + " @19157707002"
